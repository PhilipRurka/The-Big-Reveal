...
--
-- Name: profiles Public profiles are viewable by their user.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Public profiles are viewable by their user." ON "public"."profiles" FOR SELECT USING (("auth"."uid"() = "id"));
