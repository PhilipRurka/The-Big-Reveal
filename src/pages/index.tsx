...
import { PostPageData } from '../components/post/Post.type';
...
export const getStaticProps: GetStaticProps = () => {
  const initialValues: PostPageData = staticInitValues
  return { props: { ...initialValues }}
}

function HomePage({ ...initialValues }: PostPageData) {
  return <Home {...initialValues} />
}
